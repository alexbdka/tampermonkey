                ...
                if (response.status === 200) {
                    ...
                    if (data.Count > 0) {
                        ...
                        if (bestMatch) {
                            ...
                            button.style.backgroundColor = '#d9534f';
                            button.innerHTML = "Aucun mod similaire trouvé.";
                        }
                    } else {
                        console.log("[WARN] Aucun mod trouvé pour cet auteur.");
                        button.style.backgroundColor = '#d9534f';
                        button.innerHTML = "Aucun mod trouvé pour cet auteur.";
                    }
                } else {
                    console.error("[ERROR] La recherche par auteur a échoué avec le statut: ", response.status);
                    button.style.backgroundColor = '#d9534f';
                    button.innerHTML = "Erreur de recherche.";
                }
            },
